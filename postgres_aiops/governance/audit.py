...
_log = logging.getLogger("postgres-aiops.audit")

# Back-compat override hook. When None (default) the path resolves via
# ops_path("audit.db") (honoring POSTGRES_AIOPS_HOME). Downstream code/tests may set this
# to a fixed Path to redirect the default DB — kept so the POSTGRES_AIOPS_HOME refactor
